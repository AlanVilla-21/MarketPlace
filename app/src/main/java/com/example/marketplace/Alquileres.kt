...
import com.example.marketplace.databinding.ActivityAlquileresBinding
...
class Alquileres : AppCompatActivity() {

    private lateinit var binding: ActivityAlquileresBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlquileresBinding.inflate(layoutInflater)
