...
import com.example.marketplace.databinding.ActivityRopaVaronBinding
...
class RopaVaron : AppCompatActivity() {

    private lateinit var binding: ActivityRopaVaronBinding
