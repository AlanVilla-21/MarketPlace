...
import com.example.marketplace.databinding.ActivityRopaBebeBinding
...
class RopaBebe : AppCompatActivity() {

    private lateinit var binding: ActivityRopaBebeBinding
