...
import com.example.marketplace.databinding.ActivityElectronicaBinding
...
class Electronica : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityElectronicaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityElectronicaBinding.inflate(layoutInflater)
